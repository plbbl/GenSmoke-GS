> **Note**: This file is the upstream **ubc-vision/3dgs-mcmc** project README (paper page, BibTeX, original install). **This release** uses the root [**README.md**](../README.md) for environment and training—not the conda/PyTorch pins below.
...
Demo video: [project website](https://ubc-vision.github.io/3dgs-mcmc/).
